...
@SysDatasourceWork(datasource="hi")
public class HiWork extends LtsWork {
	...
	public void onComplete(List<JobResult> jobResults) {
        ...
        if (CollectionUtils.isNotEmpty(jobResults)) {
            for (JobResult jobResult : jobResults) {
                System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()) + " HiWork任务执行完成：" + jobResult);
            }
        }
	}
