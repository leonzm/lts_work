...
import com.company.exception.HttpFailException;
 ...
 *
 */
public class Tool_OkHttp {

	private static final Logger LOGGER = LogManager.getLogger(Tool_OkHttp.class.getName());
